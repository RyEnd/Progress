...
//    }
    ...
    public void getPostByIdTest() {
        Post post = dao.createPost(post1);
        Post postFromDb = dao.getPostById(post.getPostId());
        assertEquals(post.getPostId(), postFromDb.getPostId());
    }
    ...
    public void getAllPost() {
        ...
        assertEquals(postA.getPostId(), listOfPosts.get(0).getPostId());
        assertEquals(postB.getPostId(), listOfPosts.get(1).getPostId());
    }
    ...
    public void updatePostTest() {
        ...
        List<Tag> tListUpdate = new ArrayList<Tag>();
        Tag tag1 = new Tag();
    ...
    public void getPostByTagName() {
        ...
        assertEquals(listOfPostWithTagName.get(0).getPostId(), postA.getPostId());
    ...
    public void getPostByCategoryIdTest(){
        ...
        assertEquals(postA.getPostId(), listOfPostWithCat.get(0).getPostId());
        assertEquals(postB.getPostId(), listOfPostWithCat.get(1).getPostId());
    ...
    @Test
    public void getAllActiePostTest(){
    ...
    public void getActivePostCondition2Test(){
        ...
        assertEquals(activePostList.get(0).getPostId(), postD.getPostId());
