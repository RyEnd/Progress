...
<div class="col-xs-10 col-xs-offset-1">
    <div class="row">
        ...
        <div class="col-xs-6">
            <button class="btn btn-default dropdown-toggle pull-right" type="button" id="dropdownMenu4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Categories 
                <span class="caret"></span>
            </button>
            <ul class="dropdown-menu pull-right" aria-labelledby="dropdownMenuDivider">
            </ul>
        </div>
    </div>
    <div class="row">
