    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="mainNavBar">
                ...
                <c:forEach var="navBarItem"  items="${navBar}"> 
                    <c:choose >
                        <c:when test="${navBarItem.pageFk == 0 && navBarItem.navBarLocationId == 1}" >
                            <a class="navbar-brand" href="/TheVenue/blog/active">Home</a> 
                        </c:when>
                        <c:when test="${navBarItem.pageFk eq 0}" >
                            <a class="navbar-brand" href="/TheVenue/blog/active">Blog</a> 
                        </c:when>
                        <c:otherwise>
            ...
            <div class="collapse" id="signIn">
                <a href="/TheVenue/control"><button type="button" class="btn btn-default navbar-btn navbar-right pull-right">Sign in</button></a>
            </div>
        </div>
    </div>
</nav>